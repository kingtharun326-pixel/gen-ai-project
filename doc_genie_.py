...
Original file is located at
    https://colab.research.google.com/drive/10FT4IpQ1NU3g1Vdtnk0DP7bmDEVLEeBQ
"""

!pip install transformers gradio torch black autopep8 reportlab requests
...
response = pipe("Explain Python recursion")
print(response)
